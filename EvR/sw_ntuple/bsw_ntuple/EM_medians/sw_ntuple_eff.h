...
#ifndef sw_ntuple_eff_h
#define sw_ntuple_eff_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   double  L12_DPhi_cut1, L12_DPhi_cut2;
   double  L12_DEta_cut1, L12_DEta_cut2;

   double  L13_DPhi_cut1, L13_DPhi_cut2;
   double  L13_DEta_cut1, L13_DEta_cut2;

   double  L14_DPhi_cut1, L14_DPhi_cut2;
   double  L14_DEta_cut1, L14_DEta_cut2;

   double  L23_DPhi_cut1, L23_DPhi_cut2;
   double  L23_DEta_cut1, L23_DEta_cut2;

   double  L24_DPhi_cut1, L24_DPhi_cut2;
   double  L24_DEta_cut1, L24_DEta_cut2;

   double  L34_DPhi_cut1, L34_DPhi_cut2;
   double  L34_DEta_cut1, L34_DEta_cut2;
   ...
   void SetSingalBoundary(int region, int EgEt, float dphi_width, float deta_width);

   sw_ntuple_eff(TTree *tree=0);
   virtual ~sw_ntuple_eff();
...
#ifdef sw_ntuple_eff_cxx
sw_ntuple_eff::sw_ntuple_eff(TTree *tree) : fChain(0) 
{
...
sw_ntuple_eff::~sw_ntuple_eff()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t sw_ntuple_eff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sw_ntuple_eff::LoadTree(Long64_t entry)
{
...
void sw_ntuple_eff::Init(TTree *tree)
{
...
void sw_ntuple_eff::Show(Long64_t entry)
{
...
Int_t sw_ntuple_eff::Cut(Long64_t entry)
{
...
double sw_ntuple_eff::getMedian(const std::vector<float> &vec)
{
...
double sw_ntuple_eff::getMedianErr(const std::vector<float> &vec)
{
  double err = 0.;
...
double sw_ntuple_eff::ROI_func(int region, double eget){
  double p[5];
...
void sw_ntuple_eff::SetSingalBoundary(int region, int EgEt, float dphi_width, float deta_width){

      float EG_pixel_dphi_upper_width = dphi_width;
      float EG_pixel_dphi_lower_width = dphi_width;

      // pixel-EG 
      L12_DPhi_cut1 = SW_func2_dphi_v2(region, EgEt);
      L12_DPhi_cut2 = SW_func2_dphi_v2(region, EgEt);

      L12_DPhi_cut1 = L12_DPhi_cut1   + EG_pixel_dphi_upper_width;
      L12_DPhi_cut2 = L12_DPhi_cut2 - EG_pixel_dphi_lower_width;

      L13_DPhi_cut1 = SW_func2_dphi_v2(region, EgEt);
      L13_DPhi_cut2 = SW_func2_dphi_v2(region, EgEt);

      L13_DPhi_cut1 = L13_DPhi_cut1   + EG_pixel_dphi_upper_width;
      L13_DPhi_cut2 = L13_DPhi_cut2 - EG_pixel_dphi_lower_width;

      L14_DPhi_cut1 = SW_func2_dphi_v2(region, EgEt);
      L14_DPhi_cut2 = SW_func2_dphi_v2(region, EgEt);

      L14_DPhi_cut1 = L14_DPhi_cut1   + EG_pixel_dphi_upper_width;
      L14_DPhi_cut2 = L14_DPhi_cut2 - EG_pixel_dphi_lower_width;

      L23_DPhi_cut1 = SW_func2_dphi_v2(region, EgEt);
      L23_DPhi_cut2 = SW_func2_dphi_v2(region, EgEt);

      L23_DPhi_cut1 = L23_DPhi_cut1   + EG_pixel_dphi_upper_width;
      L23_DPhi_cut2 = L23_DPhi_cut2 - EG_pixel_dphi_lower_width;

      L24_DPhi_cut1 = SW_func2_dphi_v2(region, EgEt);
      L24_DPhi_cut2 = SW_func2_dphi_v2(region, EgEt);

      L24_DPhi_cut1 = L24_DPhi_cut1   + EG_pixel_dphi_upper_width;
      L24_DPhi_cut2 = L24_DPhi_cut2 - EG_pixel_dphi_lower_width;

      L34_DPhi_cut1 = SW_func2_dphi_v2(region, EgEt);
      L34_DPhi_cut2 = SW_func2_dphi_v2(region, EgEt);
      
      L34_DPhi_cut1 = L34_DPhi_cut1   + EG_pixel_dphi_upper_width;
      L34_DPhi_cut2 = L34_DPhi_cut2 - EG_pixel_dphi_lower_width;

      float EG_pixel_deta_upper_width = deta_width;
      float EG_pixel_deta_lower_width = deta_width;

      L12_DEta_cut1 = SW_func2_deta_v2(EgEt);
      L12_DEta_cut2 = SW_func2_deta_v2(EgEt);

      L12_DEta_cut1 = L12_DEta_cut1   + EG_pixel_deta_upper_width;
      L12_DEta_cut2 = L12_DEta_cut2 - EG_pixel_deta_lower_width;

      L13_DEta_cut1 = SW_func2_deta_v2(EgEt);
      L13_DEta_cut2 = SW_func2_deta_v2(EgEt);

      L13_DEta_cut1 = L13_DEta_cut1   + EG_pixel_deta_upper_width;
      L13_DEta_cut2 = L13_DEta_cut2 - EG_pixel_deta_lower_width;

      L14_DEta_cut1 = SW_func2_deta_v2(EgEt);
      L14_DEta_cut2 = SW_func2_deta_v2(EgEt);

      L14_DEta_cut1 = L14_DEta_cut1   + EG_pixel_deta_upper_width;
      L14_DEta_cut2 = L14_DEta_cut2 - EG_pixel_deta_lower_width;

      L23_DEta_cut1 = SW_func2_deta_v2(EgEt);
      L23_DEta_cut2 = SW_func2_deta_v2(EgEt);

      L23_DEta_cut1 = L23_DEta_cut1   + EG_pixel_deta_upper_width;
      L23_DEta_cut2 = L23_DEta_cut2 - EG_pixel_deta_lower_width;

      L24_DEta_cut1 = SW_func2_deta_v2(EgEt);
      L24_DEta_cut2 = SW_func2_deta_v2(EgEt);

      L24_DEta_cut1 = L24_DEta_cut1   + EG_pixel_deta_upper_width;
      L24_DEta_cut2 = L24_DEta_cut2 - EG_pixel_deta_lower_width;

      L34_DEta_cut1 = SW_func2_deta_v2(EgEt);
      L34_DEta_cut2 = SW_func2_deta_v2(EgEt);

      L34_DEta_cut1 = L34_DEta_cut1   + EG_pixel_deta_upper_width;
      L34_DEta_cut2 = L34_DEta_cut2 - EG_pixel_deta_lower_width;

}

void sw_ntuple_eff::MakeHistograms(TString hname, int nbins, float xmin, float xmax){
...
TH1* sw_ntuple_eff::GetHist(TString hname){
...
void sw_ntuple_eff::FillHist(TString histname, float value, float w, float xmin, float xmax, int nbins){
