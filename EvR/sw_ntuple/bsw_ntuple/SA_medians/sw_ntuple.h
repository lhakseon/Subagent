...
double sw_ntuple::StandaloneDPhi_BS(TVector3& first_hit, TVector3& second_hit){

 return deltaPhi((second_hit - first_hit).Phi(), first_hit.Phi());

}

double sw_ntuple::StandaloneDPhi(TVector3& first_hit, TVector3& second_hit, TVector3& third_hit){

 return deltaPhi((third_hit - second_hit).Phi(), (second_hit - first_hit).Phi());

}

double sw_ntuple::StandaloneDEta(TVector3& first_hit, TVector3& second_hit, TVector3& third_hit){
