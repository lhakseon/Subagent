void draw_roi_pixelDependance()
{
 ...
 TString nth_sw = "Pix_Pix_dphi_SW_1";
 TGraphErrors *roi; 
 ...
 roi->GetYaxis()->SetRangeUser(-0.02, 0.02);
 roi->Draw("apeZ");
 ...
 for(int i = 2;i < 11; i++){
    ...
    roi = (TGraphErrors*)infile1->Get("Pix_Pix_dphi_SW_"+ nth_sw_ + "_eta_region_"+eta_region+"_median");
