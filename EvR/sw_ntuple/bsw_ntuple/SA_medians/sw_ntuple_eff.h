...
double sw_ntuple_eff::StandaloneDPhi_BS(TVector3& first_hit, TVector3& second_hit){

 return deltaPhi((second_hit - first_hit).Phi(), first_hit.Phi());

}

double sw_ntuple_eff::StandaloneDPhi(TVector3& first_hit, TVector3& second_hit, TVector3& third_hit){

 return deltaPhi((third_hit - second_hit).Phi(), (second_hit - first_hit).Phi());

}

double sw_ntuple_eff::StandaloneDEta(TVector3& first_hit, TVector3& second_hit, TVector3& third_hit){
...
void sw_ntuple_eff::SetSingalBoundary(int region, int EgEt, float dphi_width, float deta_width){
      ...
      // pixel-pixel 
      //float pixel_pixel_dphi_upper_width = 0.005;
      //float pixel_pixel_dphi_lower_width = 0.005;
      float pixel_pixel_dphi_upper_width = dphi_width;
      float pixel_pixel_dphi_lower_width = dphi_width;
      ...
      //float pixel_pixel_deta_upper_width = 0.005;
      //float pixel_pixel_deta_lower_width = 0.005;

      float pixel_pixel_deta_upper_width = deta_width;
      float pixel_pixel_deta_lower_width = deta_width;
/*
      if(region==5){
