void draw_sw_eff(int region, int et){

 TString et10 = "Et10_11_R";
 TString et50 = "Et50_51_R";

 TString sw[10] = {"L012_dphi_", "L013_dphi_", "L014_dphi_", "L023_dphi_", "L024_dphi_", "L034_dphi_", "L123_dphi_", "L124_dphi_", "L134_dphi_", "L234_dphi_"};
 ...
 for(int i = 0; i < 10; i++){
     ...
     h_nom->GetXaxis()->SetTitle("#Delta phi cut");
 ...
 TString region_;
 region_.Form("%d", region);
 if(et==10) c1->SaveAs( et10 + region_ + "_eff.pdf");
 if(et==50) c1->SaveAs( et50 + region_ +"_eff.pdf");
 delete c1;
